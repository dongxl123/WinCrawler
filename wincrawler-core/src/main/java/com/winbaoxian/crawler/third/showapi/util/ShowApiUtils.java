package com.winbaoxian.crawler.third.showapi.util;

import com.winbaoxian.crawler.third.showapi.Constants;
import com.winbaoxian.crawler.third.showapi.FileItem;
...
public class ShowApiUtils {
    ...
    public static String signRequest(Map<String, String> params, String secret) throws IOException {
        ...
        for (String key : keys) {
            ...
            if (!StringUtils.isAllBlank(key, value)) {
